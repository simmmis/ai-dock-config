...
function provisioning_dima_wget_list() {
    ...
    curl -L -O -J -s -H "Authorization: Bearer 5d4959dad81a395f366e32ce895c003c" -o "/workspace/ComfyUI/models/loras/" "https://civitai.com/api/download/models/745845?type=Model&format=SafeTensor"
    curl -L -O -J -s -H "Authorization: Bearer 5d4959dad81a395f366e32ce895c003c" -o "/workspace/ComfyUI/models/loras/" "https://civitai.com/api/download/models/738658?type=Model&format=SafeTensor"
    curl -L -O -J -s -H "Authorization: Bearer 5d4959dad81a395f366e32ce895c003c" -o "/workspace/ComfyUI/models/loras/" "https://civitai.com/api/download/models/720252?type=Model&format=SafeTensor"
